...
MODULE_NAME = "apps.api.alembic.versions.20260313_0022_task_workspaces"
...
def test_upgrade_executes_expected_statements_in_order(monkeypatch) -> None:
    ...
    assert executed == [
        ...
        *module._UPGRADE_GRANT_STATEMENTS,
        ...
        "ALTER TABLE task_workspaces FORCE ROW LEVEL SECURITY",
...
def test_task_workspace_privileges_allow_only_expected_runtime_writes() -> None:
    module = load_migration_module()
