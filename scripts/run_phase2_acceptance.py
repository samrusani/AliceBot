...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the bounded Phase 2 acceptance evidence suite.",
    )
    parser.add_argument(
        "--induce-failure",
...
def main() -> int:
    ...
    print("Phase 2 acceptance test subset:")
    ...
    if completed.returncode == 0:
        print("Phase 2 acceptance suite result: PASS")
    else:
        print(f"Phase 2 acceptance suite result: FAIL (exit code {completed.returncode})")
