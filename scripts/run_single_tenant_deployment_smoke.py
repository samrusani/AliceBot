...
def validate_caddyfile(text: str) -> None:
    ...
    _require("reverse_proxy 127.0.0.1:8000" in normalized, "caddy_api_upstream_invalid")
    _require("reverse_proxy 127.0.0.1:3000" in normalized, "caddy_web_upstream_invalid")
