...
- `v0.15.3` is the latest published release. Its immutable release record is
  `docs/release/v0.15.3-release-notes.md`, with artifact digests in
  `docs/release/v0.15.3-checksums.txt`. (The `v0.13.0` tag was never
