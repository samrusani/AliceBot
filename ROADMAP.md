...
- `v0.9.1`: latest published release. It includes the historical
...
- `v0.9.2`: release candidate. The target is a security and reliability
  patch for project-bound authorization, lifecycle consistency, SQLite
  backup/restore, data-bearing upgrades, retrieval bounds, vulnerable web
  dependencies, package resources, and release provenance. It is not tagged
  or published until one exact clean SHA passes the canonical release check
  and review.

## Next

In rough priority order after v0.9.2:
