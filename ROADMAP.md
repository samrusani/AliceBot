...
- `v0.9.4`: latest published release. A security and reliability hotfix over
  ...
  v0.10.2 remediation gate. Tagged and published on PyPI and GitHub as an immutable release,
...
- `v0.10.2`: active audit-remediation candidate over the published, immutable
  ...
  review. No `v0.10.2` work has shipped; it is not tagged or published until
  every required check passes on one exact clean SHA.

## Next

After the v0.10.2 audit-remediation gate is approved, continue in this order:
