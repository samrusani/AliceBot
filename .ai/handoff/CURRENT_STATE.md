...
- `v0.15.3` is the latest published release. It is available from PyPI and
  its record is immutable. `v0.13.1` is the prior published release, and
  GitHub; exact artifact digests are in
  `docs/release/v0.15.3-checksums.txt`. `v0.13.1` shipped the Phase 4
...
`v0.15.3` is tagged, published, and immutable. Its authoritative records are:

- `docs/release/v0.15.3-release-notes.md`
- `docs/release/v0.15.3-checksums.txt`
