...
- run the release checklist and runbook end-to-end on a clean environment
- cut `v0.1.0` tag only after those gates pass
- add canonical Phase 10 planning docs before creating another sprint

## Control Note

- There is no non-redundant Phase 9 sprint remaining.
- The active sprint slot should remain empty until Phase 10 is defined.
