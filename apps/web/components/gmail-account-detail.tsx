...
export function GmailAccountDetail({
  account,
  source,
  unavailableReason,
}: GmailAccountDetailProps) {
  ...
  if (!account) {
    return (
      <SectionCard
        ...
        description="Select one connected Gmail account to inspect metadata and scope summary."
      >
        <EmptyState
  ...
  return (
    <SectionCard
      ...
      description="Account detail stays bounded to connector metadata and scope without expanding into mailbox views."
    >
      <div className="detail-grid">
        ...
        <div className="detail-group detail-group--muted">
          ...
          <p className="muted-copy">
            This route uses the shipped read-only Gmail account seam and explicit single-message ingestion
            seam only. It does not expand into mailbox search, sync, or write actions.
          </p>
        </div>
      </div>
    </SectionCard>
