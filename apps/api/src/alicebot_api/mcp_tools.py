...
def _build_recall_query(arguments: Mapping[str, object], *, limit: int) -> ContinuityRecallQueryInput:
    return ContinuityRecallQueryInput(
        ...
        topic=_parse_optional_text(arguments, "topic"),
        project_entity_id=_parse_optional_uuid(arguments, "project_entity_id"),
        person_entity_id=_parse_optional_uuid(arguments, "person_entity_id"),
        topic_entity_id=_parse_optional_uuid(arguments, "topic_entity_id"),
