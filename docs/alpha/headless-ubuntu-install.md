...
(`v0.15.6`) for an immutable deployment.
...
For an immutable install after a release tag is published, replace `--branch main` with the latest published release tag (`v0.15.6`): `--tag v0.15.6`.
