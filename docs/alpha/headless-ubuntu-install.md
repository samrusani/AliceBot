...
(`v0.15.4`) for an immutable deployment.
...
For an immutable install after a release tag is published, replace `--branch main` with the latest published release tag (`v0.15.4`): `--tag v0.15.4`.
