...
Define the next public pre-1.0 tag cut for Alice after the completed Phase 13 boundary.
The latest published tag remains `v0.3.2` until this plan is executed.

## Tag Target

- semantic version: `v0.4.0`
- target branch: `main` after accepted Phase 13 closeout / release-update merge
- release type: pre-1.0 public release

## Required Inputs

- passing release checklist: `docs/release/v0.4.0-release-checklist.md`
- current `docs/archive/process/BUILD_REPORT.md` and `docs/archive/process/REVIEW_REPORT.md`
- release notes from `CHANGELOG.md`
- Phase 13 closeout summary: `docs/archive/process/phase13-closeout-summary.md`
...
git tag -a v0.4.0 -m "Alice v0.4.0: one-call continuity, Alice Lite, and hygiene / conversation health visibility"
...
- Phase 13 one-call continuity, Alice Lite, and hygiene / thread-health visibility

## Explicitly Deferred Beyond `v0.4.0`
