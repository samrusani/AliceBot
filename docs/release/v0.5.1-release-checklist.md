...
This checklist is scoped to the completed Alice surface through Phase 14 plus `HF-001`.

## 1) Repo and Environment Prep

- [ ] On `main` or an explicit `v0.5.1` release-prep branch
...
- [ ] `README.md` accurately describes the completed Phase 14 + `HF-001` surface and the `v0.5.1` release boundary
- [ ] `docs/quickstart/local-setup-and-first-result.md` matches the shipped Alice Lite and logging-safety path
...
- [ ] `docs/archive/process/phase14-closeout-summary.md` matches the shipped Phase 14 scope
- [ ] release checklist, tag plan, and runbook are mutually consistent

## 5) Evidence Artifacts

- [ ] `docs/archive/process/BUILD_REPORT.md` updated with exact commands and outcomes
- [ ] `docs/archive/process/REVIEW_REPORT.md` updated for the closeout/release update state
- [ ] release evidence names the exact shipped scope included in the `v0.5.1` target
...
- [ ] `SECURITY.md` present
- [ ] `LICENSE` present
- [ ] `CHANGELOG.md` includes a Phase 14 closeout / `v0.5.1` release entry
...
When all boxes pass, execute the tag procedure in `docs/release/v0.5.1-tag-plan.md`.
