...
The vNext architecture is now the active Alice product line. `v0.9.1` is the
latest published release and `v0.9.2` is the current, unpublished release
candidate. Alice remains local-first rather than a hosted launch; install the
...
11. Review the [v0.9.2 release-candidate notes](../release/v0.9.2-release-notes.md)
