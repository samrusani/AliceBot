...
The vNext architecture is now the active Alice product line. `v0.9.4` is the
latest published release and `v0.10.0` is the current, unpublished
audit-remediation candidate. Alice remains local-first rather than a hosted launch; install the
...
11. Review the [latest published release notes](../release/v0.9.4-release-notes.md)
