...
- Merge behavior is explicit and deterministic: lexical-first precedence, stable tie-breakers, shared final limit handling, and deterministic trace ordering are implemented in [compiler.py](/Users/samirusani/Desktop/Codex/AliceBot/apps/api/src/alicebot_api/compiler.py).
