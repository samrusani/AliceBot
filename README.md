...
- [ARCHITECTURE.md](ARCHITECTURE.md): implemented technical boundaries and planned-later boundaries.
- [ROADMAP.md](ROADMAP.md): forward-looking milestone direction from the current repo position.
- [RULES.md](RULES.md): durable engineering and scope rules.
- [.ai/handoff/CURRENT_STATE.md](.ai/handoff/CURRENT_STATE.md): compact current-state recovery snapshot.
- [.ai/active/SPRINT_PACKET.md](.ai/active/SPRINT_PACKET.md): active builder scope.
- [docs/archive/sprints](docs/archive/sprints): archived sprint build and review history.
